...
async function main() {
    ...
    var options = { value: ethers.BigNumber.from('1000000000000000000'), gasPrice: 250000000000, gasLimit: 8000000 }
    const ownerWallet = new ethers.Wallet('fc22cb995181f45fc0d9bf6a26bd686bcc30c6e1a2c0e02df08497809ba84931', ethers.provider)

    const router = new ethers.Contract('0xB78A47E883310FfE8Dcf49D54D69F4986044D237', routerAbi(), ethers.provider);
    console.log('Router:', router.address);

    const result = await router.connect(ownerWallet).addLiquidityAVAX(
